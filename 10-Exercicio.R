...
hist(x, prob=TRUE, ylim=c(0,2),breaks=20, main = "Histograma de x")
...
p = 0.8 #Sucesso
n=10 #amostra
x=7 # probabilidade de 7 ter sucesso
...
# Se a tempo de processamento diminui com o tempo teremos um 
